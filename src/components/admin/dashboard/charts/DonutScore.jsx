  ...
  return (
    <div className="bg-white p-3 flex items-center flex-col lg:flex-row">
      ...
      <div className="flex flex-col gap-1 flex-1">
        <div>
          <p className="font-medium text-gray-800 mb-0">Witness Testimony Relevance Score <span className=" indicate-dots bg-[#ff0001] w-[8px] h-[8px] rounded-full d-inline-block"></span></p>
          <p className="text-[#286578] font-semibold text-sm mb-0">
            {driverScore}
            {/* <span className=" mb-0">(Assessment Year 2024)</span> */}
          </p>
        </div>
        <div>
          <p className="font-medium text-gray-800 mb-0">Evidence Quality Score  <span className=" indicate-dots bg-[#fb6a00] w-[8px] h-[8px] rounded-full d-inline-block"></span></p>
          <p className="text-[#286578] font-semibold text-sm">{vehicleScore}</p>
        </div>
        <div>
          <p className="font-medium text-gray-800 mb-0">Investigation Quality Score  <span className=" indicate-dots bg-[#04ad00] w-[8px] h-[8px] rounded-full d-inline-block"></span></p>
          <p className="text-[#286578] font-semibold text-sm">
            {behaviourScore}
            {/* <span className=" text-[#286578]">(Assessment Year 2024)</span> */}
          </p>
        </div>
      </div>
