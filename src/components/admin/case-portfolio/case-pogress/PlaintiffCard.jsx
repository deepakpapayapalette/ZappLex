...
const PlaintiffCard = ({ setCheckFileModal, checkFileName, evidanceType }) => {
  ...
  function renderContent() {
    switch (activeTab) {
      ...
      case "evidence":
        return <><EvidenceCard
          setCheckFileModal={setCheckFileModal}
          checkFileName={checkFileName}
          evidanceType2={evidanceType}
